    ...
    if #cls > 0 then
        ...
        for k, c in ipairs(cls) do
            ...
            then
                ...
                if this_x == 0
                then
                    g.width = g.width - (2 + gap_factor) * useless_gap + 0
                    g.x = g.x + useless_gap
                else
                    g.width = g.width - (1 + gap_factor) * useless_gap + 0
                end

                if this_y == 0
                then
                    g.height = g.height - (2 + gap_factor) * useless_gap + 0
                    g.y = g.y + useless_gap
                else
                    g.height = g.height - (1 + gap_factor) * useless_gap + 0
                end
            end
            -- End of useless gap.
